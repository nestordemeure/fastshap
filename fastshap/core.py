...
class BaseExplainer():
  ...
  def __init__(self, learn:Learner, test_data:pd.DataFrame=None, test_dl:TabularDataLoaders=None):
    "Set up base class"
...
class KernelExplainer(BaseExplainer):
  def __init__(self, learn:Learner, test_data:pd.DataFrame=None, test_dl:TabularDataLoaders=None, l1_reg:bool=False):
    ...
    self._e = shap.KernelExplainer(pred_data, self._train)
